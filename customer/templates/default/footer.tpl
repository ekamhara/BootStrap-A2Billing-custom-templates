				...
				<div class="span10">
							<div id="footerlogin" class="footerlogin">
						      	<div class="span12 firstfooter" style="margin-left:0px;"> 
						        	<img src="templates/{$SKIN_NAME}/images/comodo_secure.png" class="secureimg" alt="Comodo Secure">
						        </div>
						        ...
						        <div class="span12" style="text-align:right;height:100px;margin:0px;"> 
						        	 <img src="templates/{$SKIN_NAME}/images/footer-logo.png" style="padding-right: 20px;" alt="Comodo Secure">
						        </div>
